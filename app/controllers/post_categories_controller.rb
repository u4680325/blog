class PostCategoriesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @post_category.update(post_category_params)
        format.html { redirect_to @post_category, notice: "Post category was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to post_categories_path, notice: "Post category was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def post_category_params
      params.expect(post_category: [ :name, :pattern ])
    end
end
